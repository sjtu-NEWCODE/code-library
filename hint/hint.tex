...
\section{长方体表面两点最短距离}
\inputminted{cpp}{\source/hints/distance-on-surface-of-cuboid.cpp}
...
\input{Bernoulli-Number-Reshiram.tex}

\section{博弈游戏-Reshiram}
\input{Game-Theory-Reshiram.tex}
...
\includepdf[pages={1-7}]{\source/hints/BigDecimal.pdf}
